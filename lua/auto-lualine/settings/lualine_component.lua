...
local icons = require("auto-lualine.icons")
local formatter = require("auto-lualine.settings.formatter")
local linter = require("auto-lualine.settings.linter")
...
return {
  ...
  get_branch = function()
    if vim.b.gitsigns_head ~= nil then
      return icons.Branch3 .. " " .. getLeftSubstring(vim.b.gitsigns_head, 6)
    else
      return icons.NoBranch .. vim.fn.fnamemodify("", ":t")
    end
  end,
